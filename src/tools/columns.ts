export const columns: {id: string, name: string, type: string, required: boolean}[] = [
    ...
    { id: 'bordreauxNumber', name: ' BORDREAUX N°', type: 'text', required: true },
    { id: 'marge', name: 'MARGE', type: 'text', required: true},
    { id: 'echeance', name: 'ECHEANCE', type: 'text', required: true }
  ];